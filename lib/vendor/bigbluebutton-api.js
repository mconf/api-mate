...
(function() {
  var BigBlueButtonApi, filterCustomParameters, include, root;
  ...
  BigBlueButtonApi = (function() {
    ...
    BigBlueButtonApi.prototype.availableApiCalls = function() {
      return ['/', 'create', 'join', 'isMeetingRunning', 'getMeetingInfo', 'end', 'getMeetings', 'getDefaultConfigXML', 'setConfigXML', 'getRecordings', 'publishRecordings', 'deleteRecordings'];
    };
