...
(function() {
  ...
  template = "<table class='table table-condensed result-set'>     <thead>       <tr>         <th><h3 class='label-title'>Results {{title}}:</h5></th>       </tr>     </thead>     <tbody>       {{#urls}}         <tr class='{{urlClass}}'>           <td>             <span class='method-name'>{{name}}</span>             <a class='api-link' href='{{url}}'>{{urlName}}</a>           </td>         </tr>       {{/urls}}     </tbody>   </table>";
